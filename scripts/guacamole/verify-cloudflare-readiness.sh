...
CLOUDFLARE_NAMESPACE="${CLOUDFLARE_NAMESPACE:-cloudflare}"
CLOUDFLARE_SECRET="${CLOUDFLARE_SECRET:-cloudflared-guacamole-token}"
...
echo "  - Cloudflare Access is optional; do not add it unless Scott asks"
